...
curl -s https://raw.githubusercontent.com/sxbai/Uptime-Kuma-on-replit/master/.replit
curl -s https://raw.githubusercontent.com/sxbai/Uptime-Kuma-on-replit/master/replit.nix
