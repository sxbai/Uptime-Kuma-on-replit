...
nix-shell -p wget && nix-shell -p wget
wget -O https://raw.githubusercontent.com/sxbai/Uptime-Kuma-on-replit/master/.replit
wget -C - -O https://raw.githubusercontent.com/sxbai/Uptime-Kuma-on-replit/master/replit.nix
